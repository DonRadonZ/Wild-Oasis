...
export default function SalesChart({bookings, numDays}: any) {
  ...
  const colors = isDarkMode
    ...
    : {
      ...
      return (
        <StyledSalesChart>
          <Heading as='h2'>Sales from {format(allDates.at(0) as any, 'MMM dd yyyy')} &mdash; {format(allDates.at(-1) as any, 'MMM dd yyyy')} </Heading>
